...
export default function ContactPage() {
    ...
    return (
        ...
        hover:-translate-y-1 hover:shadow-md hover:border-purple-300">
            ...
            {/* GOOGLE MAPS              */}
            {/* ========================= */}
            <section className="w-full" aria-label="Nevatrix office location on Google Maps">
                <div className="relative">
                    <div className="absolute inset-x-0 top-0 h-6 bg-gradient-to-b from-slate-100 to-transparent z-10 pointer-events-none" />
                    <iframe
                        title="Nevatrix — Web Development Company in Warangal, Telangana"
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3795.6!2d79.5941!3d17.9689!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTfCsDU4JzA4LjAiTiA3OcKwMzUnMzguOCJF!5e0!3m2!1sen!2sin!4v1713000000000!5m2!1sen!2sin"
                        width="100%"
                        height="400"
