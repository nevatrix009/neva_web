...
const services = [
    { title: "Website Design & Development", desc: "Custom, mobile-friendly websites built to rank on Google and convert visitors into customers.", href: "/services/web-development", color: "#0891B2" },
    { title: "SEO & Digital Marketing",       desc: "Local SEO, Google Ads, social media marketing and lead generation for Hanamkonda businesses.", href: "/services/digital-marketing", color: "#2563EB" },
    { title: "Ecommerce Development",         desc: "Shopify and custom online stores with Razorpay integration to sell products across Telangana.", href: "/services/ecommerce", color: "#059669" },
    { title: "Mobile App Development",        desc: "Android and iOS apps built with React Native and Flutter for startups and SMEs.", href: "/services/mobile-app", color: "#7C3AED" },
    { title: "AI Solutions & Automation",     desc: "AI chatbots, WhatsApp bots and business automation to save time and grow revenue.", href: "/services/ai-solutions", color: "#DC2626" },
    { title: "Full Stack Development",        desc: "MERN stack and Next.js web applications, SaaS platforms and custom software.", href: "/services/full-stack", color: "#D97706" },
];

const whyPoints = [
    "Local team based in Warangal — 10 minutes from Hanamkonda",
    "12+ years delivering digital solutions across Telangana",
    "100+ websites and apps built for local businesses",
    "SEO-first approach — websites built to rank from day one",
...
const faq = [
    { q: "Is Nevatrix located near Hanamkonda?", a: "Yes. Nevatrix is based in Kazipet, Warangal — less than 10 minutes from Hanamkonda. We serve all businesses in the Warangal-Hanamkonda-Kazipet (WHK) urban agglomeration." },
    { q: "Which is the best web development company in Hanamkonda?", a: "Nevatrix is the top-rated web development and digital marketing company serving Hanamkonda businesses. We build custom websites, ecommerce stores and mobile apps for retailers, manufacturers, schools, hospitals and service businesses in Hanamkonda." },
    { q: "Does Nevatrix offer SEO services in Hanamkonda?", a: "Yes. We provide local SEO, Google Business Profile optimisation, Google Ads and social media marketing specifically targeting customers in Hanamkonda and the surrounding WHK area." },
    { q: "How much does a website cost in Hanamkonda?", a: "A professional business website starts from ₹8,000. Ecommerce stores start from ₹20,000 and custom web applications start from ₹50,000. Contact Nevatrix for a free quote." },
    { q: "Does Nevatrix offer digital marketing for Hanamkonda businesses?", a: "Yes. We run Google Ads, Facebook/Instagram campaigns, WhatsApp marketing and SEO campaigns specifically targeting customers searching for businesses in Hanamkonda and Warangal." },
];

export default function HanamkondaPage() {
    return (
        <>
            <Head>
                ...
                <link rel="canonical" href="https://nevatrix.com/locations/hanamkonda" />
                <meta name="geo.region" content="IN-TG" />
                <meta name="geo.placename" content="Hanamkonda, Telangana, India" />
                <meta property="og:title" content="Web Development Company in Hanamkonda | Nevatrix" />
                <meta property="og:description" content="Nevatrix — the best web development and digital marketing company serving Hanamkonda businesses. Websites, apps, SEO and AI solutions." />
                <meta property="og:url" content="https://nevatrix.com/locations/hanamkonda" />
                ...
                <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
                    ...
                    "@type": "LocalBusiness",
                    name: "Nevatrix",
                    description: "Web development and digital marketing company serving Hanamkonda, Warangal and Telangana.",
                    ...
                    areaServed: [{ "@type": "City", name: "Hanamkonda" }, { "@type": "City", name: "Warangal" }, { "@type": "State", name: "Telangana" }],
                ...
                <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
                    ...
                    itemListElement: [
                        ...
                        { "@type": "ListItem", position: 2, name: "Locations", item: "https://nevatrix.com/locations/hanamkonda" },
                        { "@type": "ListItem", position: 3, name: "Hanamkonda", item: "https://nevatrix.com/locations/hanamkonda" },
                    ],
                }) }} />
                <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
                    "@context": "https://schema.org",
                ...
                <section className="relative min-h-[420px] flex items-center overflow-hidden loc-hero-bg">
                    ...
                    <div className="relative z-10 max-w-4xl mx-auto px-6 py-24 w-full text-center">
                        <div className="fu1 inline-flex items-center gap-2 mb-5 px-4 py-1.5 rounded-full border text-xs font-bold tracking-widest uppercase"
                            ...
                            <MapPin size={11} /> Hanamkonda, Telangana
                        </div>
                        <h1 className="fu2 text-4xl md:text-5xl font-extrabold text-white leading-tight mb-5 tracking-tight">
                            ...
                            <span style={{ color: "#60A5FA" }}>Company in Hanamkonda</span>
                        </h1>
                        ...
                        <p className="fu3 text-slate-300 text-base leading-relaxed max-w-2xl mx-auto mb-10">
                            Nevatrix is the leading web development and digital marketing company serving
                            businesses in Hanamkonda, Warangal and the WHK area. Custom websites, SEO,
                            mobile apps and AI solutions — all under one roof.
                        </p>
                ...
                <section className="py-20 px-6" style={{ background: "linear-gradient(to bottom,#F8FAFC,#ffffff)" }}>
                    <div className="max-w-6xl mx-auto">
                        <h2 className="text-3xl font-extrabold text-slate-900 text-center mb-3">
                            Our Services in Hanamkonda
                        </h2>
                        <p className="text-slate-500 text-center max-w-2xl mx-auto mb-12 text-sm leading-relaxed">
                            We serve all types of businesses in Hanamkonda — from local shops and
                            schools to manufacturers and startups — with full-stack digital solutions.
                        </p>
                    ...
                    <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-14 items-center">
                        <div>
                            <h2 className="text-3xl font-extrabold text-slate-900 mb-4">
                                Why Hanamkonda Businesses<br />Choose Nevatrix
                            </h2>
                            <div className="h-[3px] w-20 rounded-full mb-6" style={{ background: "linear-gradient(90deg,#2563EB,#0891B2)" }} />
                            <p className="text-slate-500 text-sm leading-relaxed mb-8">
                                As the nearest professional IT company to Hanamkonda, Nevatrix combines
                                local market knowledge with world-class technical expertise. We understand
                                what Hanamkonda businesses need to win online.
                            </p>
                        ...
                        <div className="space-y-5">
                            {[
                                { label: "Clients Served",      value: "100+", sub: "businesses across WHK area" },
                ...
                <section className="relative py-20 overflow-hidden loc-hero-bg">
                    ...
                    <div className="relative z-10 max-w-3xl mx-auto px-6 text-center">
                        <h2 className="text-3xl md:text-4xl font-extrabold text-white mb-5 leading-tight">
                            Ready to Grow Your<br />Hanamkonda Business Online?
                        </h2>
                        <p className="text-slate-300 text-base mb-10 max-w-xl mx-auto">
                            Contact Nevatrix today for a free consultation. We'll create a custom
                            digital strategy designed specifically for your business and market.
                        </p>
                        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-10">
                            ...
                            <a href="https://wa.me/919989183654?text=Hi%20Nevatrix%2C%20I%27m%20from%20Hanamkonda%20and%20I%27d%20like%20a%20free%20quote"
